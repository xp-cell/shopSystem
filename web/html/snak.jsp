...
<div class="mui-nav">
    <ul>
        ...
        <li><a style="color: #0000FF;" href="javascript:void(0)">休闲零食</a></li>
...
<div class="main">
    <div class="img">
        <img src="../img/snake/snake1-2.jpeg">
    </div>
    <div class="img">
        <img src="../img/snake/snake2-1.jpeg">
    </div>
    <div class="img">
        <img src="../img/snake/snake10-1.jpeg">
    </div>
    <div class="img">
        <img src="../img/snake/snake9-1.jpeg">
    </div>
    <div class="food-title" id="snake">
        <h1>好吃不容错过！</h1>
    </div>
    ...
    <script>
        ...
        $("#moreGoods").bind("click", function () {
            setCookie("goodsType",0,1,"path","html")
        })
        //获取分页商品
        $.ajax({
            type: "POST",
