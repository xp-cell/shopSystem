...
<div class="main_con clearfix">
    <div class="left_menu_con clearfix">
        <h3>用户中心</h3>
        <ul>
            <li><a href="javascript:void(0)" class="active">· 个人信息</a></li>
    ...
    <div class="right_content clearfix">
        <div class="info_con clearfix">
            ...
            <ul class="user_info_list">
                <li><span>账号：</span>12345</li>
                <li><span>昵称：</span>zhangsan</li>
                <li><span>积分：</span>10</li>
                <li><span>会员等级：</span>putonghuiyuna</li>
            </ul>
        </div>
    </div>
</div>
