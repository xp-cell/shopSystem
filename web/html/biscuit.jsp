...
<div class="mui-nav">
    <ul>
        ...
        <li><a style="color: #0000FF;" href="javascript:void(0)">饼干糕点</a></li>
...
<div class="main">
    <div class="img">
        <img src="../img/biscuit/biscuit1-2.jpeg">
    </div>
    <div class="img">
        <img src="../img/biscuit/biscuit3-3.jpeg">
    </div>
    <div class="img">
        <img src="../img/biscuit/biscuit4-1.jpeg">
    </div>
    <div class="img">
        <img src="../img/biscuit/biscuit7-2.jpeg">
    </div>
    <div class="food-title" id="biscuit">
        <h1>这家饼干真不错！</h1>
    </div>
    ...
    <script>
        $("#moreGoods").bind("click", function () {
            setCookie("goodsType",1,1,"path","html")
        })
        //获取分页商品
        $.ajax({
            type: "POST",
