...
<div class="mui-nav">
    <ul>
        ...
        <li><a style="color: #0000FF;" href="javascript:void(0)">乳品冲饮</a></li>
    </ul>
</div>
<div class="main">
    <div class="img">
        <img src="../img/drink/drink12-1.jpg">
    </div>
    <div class="img">
        <img src="../img/drink/drink5-1.jpg">
    </div>
    <div class="img">
        <img src="../img/drink/drink9-1.jpg">
    </div>
    <div class="img">
        <img src="../img/drink/drink20-1.jpg">
    </div>
    <div class="food-title" id="drink">
        <h1>畅饮一夏！</h1>
    </div>
    ...
    <script>
        $("#moreGoods").bind("click", function () {
            setCookie("goodsType",3,1,"path","html")
        })
        //获取分页商品
        $.ajax({
            type: "POST",
